...
from scraper.views import home_view, list_view, v_detail, VDetail, VList, VCreate, VUpdate, VDelete

urlpatterns = [
    path('admin/', admin.site.urls),
    path('list/', VList.as_view(), name='list'),
    path('subscription/', include(('subscription.urls', 'subscription'))),
